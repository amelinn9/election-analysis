...
# 2. Percentage of votes from each county / total count
...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (votes > largest_count) and (county_vote_percentage > largest_percentage):
            # set largest_count = votes, largest_percentage = county_vote_percentage
            largest_count = votes
            largest_percentage = county_vote_percentage
            # set the largest_county to the largest county's name
